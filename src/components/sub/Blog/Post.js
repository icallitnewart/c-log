            ...
            <div className="inner view">
                <div className="titleBox">
                    <div className="title">
                        ...
                        <span className="writer">{postContent.writer}</span>
                        <span className="date">{postContent.date}</span>
                        <span className={(postContent.isLiked) ? "likes on" : "likes"} ref={likeBtn} onClick={(e)=>clickLikeBtn(e, postContent.index)}><i className="fas fa-heart"></i>{postContent.likes}</span>
                    </div>
                    <div className={`pic ${postContent.category.toLowerCase()}`}>
                        <i className={iconTypes[postContent.category].toLowerCase()}></i>
                ...
                <ul className="btns">
                    ...
                    <li><button onClick={()=>deletePost(postContent.index)}>Delete</button></li>
                </ul>
            </div>
        );
    }
